...
The playbook can be found here. [playbook4.yml](/Scripts/Configmgmt/ansible-scenario4/playbook4.yml)
...
There are some other files that I have modified based on the outcome we desire, take a look in the folder [ansible-scenario4](/Scripts/Configmgmt/ansible-scenario4.zip) for all the files changed. You should check the folders tasks, handlers and templates in the nginx folder and you will find those additional changes and files.
...
![Ansible Loadbalancer](Image/../../Image/Ansible-Loadbalancer01.png)
...
![Ansible Loadbalancer](Image/../../Image/Ansible-Loadbalancer02.png)
...
![Ansible Loadbalancer](Image/../../Image/Ansible-Loadbalancer03.png)
